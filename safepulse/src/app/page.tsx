...
const lineData = [
  { day: 'Mon', healthScore: 65, activeGuests: 45, rideSessions: 78, safetyAlerts: 12 },
  { day: 'Tue', healthScore: 72, activeGuests: 52, rideSessions: 85, safetyAlerts: 18 },
  { day: 'Wed', healthScore: 68, activeGuests: 48, rideSessions: 82, safetyAlerts: 15 },
  { day: 'Thu', healthScore: 75, activeGuests: 55, rideSessions: 88, safetyAlerts: 22 },
  { day: 'Fri', healthScore: 80, activeGuests: 58, rideSessions: 92, safetyAlerts: 28 },
  { day: 'Sat', healthScore: 85, activeGuests: 62, rideSessions: 95, safetyAlerts: 35 },
  { day: 'Sun', healthScore: 78, activeGuests: 56, rideSessions: 89, safetyAlerts: 30 },
];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-sm font-medium text-gray-700">SafePulse Park</span>
                <span className="px-2 py-1 text-xs bg-green-100 text-green-800 rounded-full">Premium</span>
              </div>
            </div>
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Here's what's happening with your health-aware amusement platform today.</p>
          </div>

          {/* KPI Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {kpiCards.map((card, index) => (
              <div key={index} className={`${card.color} rounded-xl p-6 relative overflow-hidden`}>
                <div className="absolute top-0 right-0 w-32 h-32 opacity-10">
                  <div className="w-full h-full bg-current rounded-full"></div>
                </div>
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <div className={`p-2 rounded-lg ${card.iconColor} bg-white/50`}>
                      <card.icon className="w-6 h-6" />
                    </div>
                    <div className={`flex items-center text-sm ${card.trend === 'up' ? 'text-green-600' : 'text-red-600'
                      }`}>
                      <span className="font-medium">{card.change}</span>
                      <svg className={`w-4 h-4 ml-1 ${card.trend === 'up' ? 'rotate-0' : 'rotate-180'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Real-time Health Monitoring</h2>
            <HealthMetrics />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Guest Health Distribution</h3>
              <div className="h-64">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Ride Safety Metrics</h3>
                <span className="text-sm text-green-600 font-medium">(+43%) than last year</span>
              </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Guest Management</h2>
            <GuestManagement />
          </div>
        </main>
      </div>
